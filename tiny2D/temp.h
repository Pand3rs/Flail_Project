...
namespace My_Game
{
	...
	namespace World
	{
		...
		namespace Parameters
		{
			...
			int chain_segments = 2;
			int chain_stretch_limit = 40;
	...
	void set_chain(Vec2D::Vec2D *p, Vec2D::Vec2D *e)
	{
		float increment_x = (e->x - p->x) / World::Parameters::chain_segments;
		float increment_y = (e->y - p->y) / World::Parameters::chain_segments;
